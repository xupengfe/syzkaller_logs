...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(*(uint32_t*)0x20000100 = 0x1e);
    NONFAILING(*(uint32_t*)0x20000104 = 0);
    NONFAILING(*(uint32_t*)0x20000108 = 0x4f400000);
    NONFAILING(*(uint32_t*)0x2000010c = 3);
  ...
  case 1:
    ...
    break;
  case 2:
    NONFAILING(memcpy((void*)0x20000100, "/dev/hpet\000", 10));
    ...
    break;
  case 3:
    res = syscall(__NR_mmap, /*addr=*/0x20ffd000ul, /*len=*/0x1000ul,
                  /*prot=*/0x2000002ul, /*flags=*/0x12ul, /*fd=*/r[1],
                  /*offset=*/0ul);
    if (res != -1)
      r[2] = res;
    break;
  case 4:
    ...
    NONFAILING(syz_memcpy_off(/*ring_ptr=*/r[2], /*off=*/0, /*src=*/0x20000040,
                              /*src_off=*/0, /*nbytes=*/4));
    break;
  }
}
