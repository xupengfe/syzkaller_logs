...
void execute_one(void)
{
  ...
  syscall(__NR_request_key, 0ul, 0ul, 0x20000080ul, 0xfffffffd);
  syscall(__NR_keyctl, 5ul, 0, 0, 0, 0);
  ...
  *(uint32_t*)0x20000130 = 8;
  *(uint32_t*)0x20000134 = 2;
  *(uint64_t*)0x20000138 = 0;
  *(uint64_t*)0x20000140 = 0;
  *(uint64_t*)0x20000148 = 0x1100;
  ...
  *(uint64_t*)0x20000178 = 0;
  ...
  if (res != -1)
    r[0] = res;
  res = syscall(__NR_signalfd, r[0], 0ul, 0ul);
  if (res != -1)
    r[1] = res;
  syscall(__NR_ioctl, r[1], 0x2405, -1);
  ...
  *(uint64_t*)0x20000178 = 0;
  ...
  syscall(__NR_ioctl, -1, 0x2400, 0xful);
}
int main(void)
{
