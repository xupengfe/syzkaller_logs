...
{
  intptr_t res = 0;
  memcpy((void*)0x20000240, "/dev/iommu\000", 11);
  ...
  *(uint64_t*)0x200000d0 = 0x20800000;
  *(uint64_t*)0x200000d8 = 0x800000;
  ...
  *(uint32_t*)0x2000011c = 0x2000;
  *(uint64_t*)0x20000120 = 0x10;
  *(uint64_t*)0x20000128 = 0;
  syscall(__NR_ioctl, r[0], 0x3ba0, 0x20000100ul);
  memcpy((void*)0x20000640, "/dev/iommu\000", 11);
  res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000640ul, 0ul, 0ul);
  if (res != -1)
    r[3] = res;
  *(uint32_t*)0x20000000 = 0xc;
  *(uint32_t*)0x20000004 = 0;
  res = syscall(__NR_ioctl, r[3], 0x3b81, 0x20000000ul);
  if (res != -1)
    r[4] = *(uint32_t*)0x20000008;
  *(uint32_t*)0x200000c0 = 0x38;
  *(uint32_t*)0x200000c4 = 2;
  *(uint32_t*)0x200000c8 = r[4];
  *(uint32_t*)0x200000cc = 0;
  res = syscall(__NR_ioctl, r[3], 0x3ba0, 0x200000c0ul);
  if (res != -1)
    r[5] = *(uint32_t*)0x200000d0;
  *(uint32_t*)0x20000140 = 8;
  *(uint32_t*)0x20000144 = r[5];
  syscall(__NR_ioctl, r[0], 0x3b80, 0x20000140ul);
}
int main(void)
{
