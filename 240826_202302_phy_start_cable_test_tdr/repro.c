...
void loop(void)
{
  ...
  *(uint64_t*)0x200003d0 = 0x20000040;
  *(uint64_t*)0x20000040 = 0x200008c0;
  *(uint32_t*)0x200008c0 = 0x20;
  *(uint16_t*)0x200008c4 = r[1];
  *(uint16_t*)0x200008c6 = 1;
  *(uint32_t*)0x200008c8 = 0;
  *(uint32_t*)0x200008cc = 0;
  *(uint8_t*)0x200008d0 = 0x1b;
  *(uint8_t*)0x200008d1 = 0;
  *(uint16_t*)0x200008d2 = 0;
  *(uint16_t*)0x200008d4 = 0xc;
  STORE_BY_BITMASK(uint16_t, , 0x200008d6, 1, 0, 14);
  STORE_BY_BITMASK(uint16_t, , 0x200008d7, 0, 6, 1);
  STORE_BY_BITMASK(uint16_t, , 0x200008d7, 1, 7, 1);
  *(uint16_t*)0x200008d8 = 8;
  *(uint16_t*)0x200008da = 1;
  *(uint32_t*)0x200008dc = r[3];
