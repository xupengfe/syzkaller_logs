...
{
  intptr_t res = 0;
  *(uint32_t*)0x20001580 = 0x11;
  *(uint32_t*)0x20001584 = 3;
  *(uint64_t*)0x20001588 = 0x20000080;
  ...
  *(uint64_t*)0x20001590 = 0x20000140;
  ...
  *(uint32_t*)0x2000160c = 0;
  res = syscall(__NR_bpf, /*cmd=*/5ul, /*arg=*/0x20001580ul, /*size=*/0x80ul);
  if (res != -1)
    r[0] = res;
