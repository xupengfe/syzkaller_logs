...
{
  intptr_t res = 0;
  memcpy((void*)0x20000040, "./cgroup/pids.max\000", 18);
  res = syscall(__NR_openat, /*fd=*/0xffffff9c, /*file=*/0x20000040ul,
                /*flags=*/0ul, /*mode=*/0ul);
  if (res != -1)
    r[0] = res;
  syscall(__NR_mmap, /*addr=*/0x20ff8000ul, /*len=*/0x1000ul, /*prot=*/0ul,
          /*flags=MAP_FIXED|MAP_SHARED*/ 0x11ul, /*fd=*/r[0], /*offset=*/0ul);
  syscall(__NR_munmap, /*addr=*/0x20ffc000ul, /*len=*/0x1000ul);
}
int main(void)
{
