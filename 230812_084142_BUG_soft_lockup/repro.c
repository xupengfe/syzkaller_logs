...
void execute_one(void)
{
  ...
  *(uint64_t*)0x200002a0 = 0x10;
  ...
  STORE_BY_BITMASK(uint64_t, , 0x200002a8, 1, 33, 1);
  STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 34, 1);
  STORE_BY_BITMASK(uint64_t, , 0x200002a8, 0, 35, 1);
  STORE_BY_BITMASK(uint64_t, , 0x200002a8, 1, 36, 1);
  STORE_BY_BITMASK(uint64_t, , 0x200002a8, 1, 37, 1);
