...
void execute_call(int call)
{
  ...
  switch (call) {
  case 0:
    NONFAILING(memcpy((void*)0x20000040, "/dev/vtpmx\000", 11));
    res = syscall(__NR_openat, 0xffffffffffffff9cul, 0x20000040ul, 0x82140ul,
                  0ul);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    NONFAILING(*(uint32_t*)0x200000c4 = 0x9e26);
    NONFAILING(*(uint32_t*)0x200000c8 = -1);
    NONFAILING(*(uint32_t*)0x200000cc = 1);
    NONFAILING(*(uint32_t*)0x200000d0 = 0x25);
    syscall(__NR_ioctl, r[0], 0xc014a100, 0x200000c0ul);
    break;
  case 2:
