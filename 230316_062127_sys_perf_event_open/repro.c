...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000360 = 0;
  ...
  syscall(__NR_ioctl, -1, 0xc0c0583b, 0x200002c0ul);
  syscall(__NR_vmsplice, -1, 0ul, 0ul, 0ul);
  *(uint32_t*)0x20000140 = 0;
  syscall(__NR_accept4, -1, 0ul, 0x20000140ul, 0x800ul);
  syscall(__NR_ioctl, -1, 0xc0c0583b, 0ul);
  syscall(__NR_ioctl, -1, 0x540f, 0ul);
  ...
  *(uint32_t*)0x200001c0 = 0;
  ...
  if (res != -1)
    r[0] = res;
  syscall(__NR_ptrace, 0x420bul, r[0], 8ul, 0ul);
  syscall(__NR_ioctl, -1, 0x2271, 0x400000ul);
}
int main(void)
{
