...
void execute_one(void)
{
  ...
  NONFAILING(memcpy((void*)0x20000100, "./cgroup/pids.max\000", 18));
  res = syscall(__NR_openat, /*fd=*/0xffffff9c, /*file=*/0x20000100ul,
                /*flags=O_RDWR*/ 2ul, /*mode=*/0ul);
  if (res != -1)
    r[0] = res;
  NONFAILING(sprintf((char*)0x20000280, "0x%016llx", (long long)0));
  syscall(__NR_write, /*fd=*/r[0], /*buf=*/0x20000280ul, /*len=*/0x12ul);
  NONFAILING(memcpy((void*)0x20000140, "/sys/power/resume", 17));
  syscall(__NR_openat, /*fd=*/0xffffffffffffff9cul, /*dir=*/0x20000140ul,
          /*flags=*/0ul, /*mode=*/0ul);
  syscall(__NR_pkey_mprotect, /*addr=*/0x20000000ul, /*len=*/0x3000ul,
          /*prot=PROT_READ*/ 1ul, /*key=*/-1);
