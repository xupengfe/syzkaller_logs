...
{
  intptr_t res = 0;
  res = syscall(__NR_socket, /*domain=*/0xaul, /*type=*/3ul, /*proto=*/3);
  if (res != -1)
    r[0] = res;
  res = syscall(__NR_socket, /*domain=*/0xaul, /*type=*/3ul, /*proto=*/3);
  if (res != -1)
    r[1] = res;
  memcpy((void*)0x20000440, "syz_tun\000\000\000\000\000\000\000\000\000", 16);
  res = syscall(__NR_ioctl, /*fd=*/r[1], /*cmd=*/0x8933, /*arg=*/0x20000440ul);
  if (res != -1)
    r[2] = *(uint32_t*)0x20000450;
  ...
  *(uint32_t*)0x2000040c = 0;
  syscall(__NR_bpf, /*cmd=*/5ul, /*arg=*/0x20000380ul, /*size=*/0x90ul);
  memcpy((void*)0x20000440, "syz_tun\000\000\000\000\000\000\000\000\000", 16);
  res = syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0x8933, /*arg=*/0x20000440ul);
  if (res != -1)
