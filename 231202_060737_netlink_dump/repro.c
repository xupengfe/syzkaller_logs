...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000ad0 = 0x20000040;
  *(uint64_t*)0x20000040 = 0x20000b00;
  memcpy((void*)0x20000b00,
         "\x14\x00\x00\x00\x14\x00\x01\x03\x00\x00\x00\x00\x00\x00\x00\x00\x08",
         17);
  *(uint64_t*)0x20000048 = 0x514;
  *(uint64_t*)0x20000ad8 = 1;
  *(uint64_t*)0x20000ae0 = 0;
  *(uint64_t*)0x20000ae8 = 0;
  *(uint32_t*)0x20000af0 = 0;
  syscall(__NR_sendmsg, /*fd=*/r[0], /*msg=*/0x20000ac0ul, /*f=*/0ul);
}
int main(void)
{
