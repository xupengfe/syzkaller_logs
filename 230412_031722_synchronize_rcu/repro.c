...
void execute_one(void)
{
  ...
  *(uint64_t*)0x200000f8 = 0;
  ...
  memcpy((void*)0x20000740, "/dev/input/mouse#\000", 18);
  res = -1;
  res = syz_open_dev(0x20000740, 0, 0x1ab302);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x200004c0 = 7;
  *(uint8_t*)0x200004c4 = 0x1b;
  *(uint16_t*)0x200004c5 = 0;
  syscall(__NR_write, r[0], 0x200004c0ul, 0xfffffff3ul);
}
int main(void)
{
